...
<div class="container">
        <h2 class="text-center pt-4" id="customerdetail" style="color : #17a2b8;font-family:Trebuchet MS; font-size:60px;text-shadow:3px 3px grey">Customers Details</h2>
        <br>
            <div class="row" style="background-color:  #E0E0E0">
                <div class="col">
                    <div class="table-responsive-sm">
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:black;">
                        <thead style="color : black; font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif">
                            <tr>

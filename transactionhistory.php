...
<html lang="en">
 ...
 ?>
	...
	<div class="container">
        <h2 class="text-center pt-4" style="color : #17a2b8;font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif; font-size:60px;text-shadow:3px 3px grey">Transaction History</h2>
